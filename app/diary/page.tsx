...
export default function DiaryPage() {
  ...
  const allDaysFilled = Object.values(
    weekNotes
  ).every((note) => note.trim() !== "");

  const handleShareWeek = async () => {
    if (!allDaysFilled) {
      alert(
        "🤎 Isi semua Day 1 - Day 7 terlebih dahulu yaa"
      );
      return;
    }
...
✨ Semangat yaa, Beariel selalu mendengarkan 🤎`;
    ...
    alert(
      "📋 One Week In Beariel berhasil dicopy!"
    );
  };
